...
change `skills/sources.json` upstream and run `mise run update better-typography`.

- Skill: `better-typography`
- Author: jakubkrehel
- Repository: https://github.com/jakubkrehel/skills.git
- Homepage: https://github.com/jakubkrehel/skills
- Upstream path: `skills/better-typography`
- Tracked ref: `main`
